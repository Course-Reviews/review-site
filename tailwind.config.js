module.exports = {
  ...
  purge: {
    ...
    options: {
      safelist: [
        ...
        /^text-(primary|secondary|info|warning|danger|success|gray)-(50|100|200|500)$/,
        ...
        /^hover:bg-(primary|secondary|info|warning|danger|success|gray)-(500)$/,
      ],
    },
  },
  ...
  theme: {
    boxShadow: {
      ...
      md: '0 0 10px -1px rgba(8, 21, 66, 0.1)',
